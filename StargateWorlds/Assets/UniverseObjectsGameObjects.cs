...
namespace StargateWorlds
{
    public partial class UniverseObjectsGameObjects
    {
        public static List<GameObject> gameObjects = new List<GameObject>()
        {
            ...
            {
                ItemID = 7,
                ItemName = "Advanced Agraculture Equipment",
                PlanetDesignation = "P3C-117",
                Description = "Agraculture Equipment developed by the Asgard that was specifically designed to grow " + 
            ...
            //    PlanetDesignation = "",
            //    Description = "",
            //    ItemType = TravelerObjectType.None,
            //    Value = 0,
            //},
        };
    }
